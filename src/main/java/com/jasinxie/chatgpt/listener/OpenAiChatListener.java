...
@Slf4j
public class OpenAiChatListener extends EventSourceListener {

    private SseEmitter sseEmitter;

    public OpenAiChatListener(SseEmitter sseEmitter) {
    ...
    public void onEvent(EventSource eventSource, String id, String type, String data) {
        ...
        ChatCompletionResponse resp = mapper.readValue(data, ChatCompletionResponse.class); // 读取Json
